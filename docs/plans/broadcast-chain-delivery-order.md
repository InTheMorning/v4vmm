...
| `v4vmm` | [0066 conversion retry and retained input 009](../tasks/adr-0066-task-009-conversion-retry-and-retained-input.md) | Complete - 2026-09-17; mechanical checks Green; [operator V1–V3](../runbooks/startup-recovery-check.md#task-009-conversion-retry-and-retained-input), normal/narrow presentation, configuration restoration and preservation accepted; fixture cleanup confirmed; task 010 not started and requires a fresh session |
