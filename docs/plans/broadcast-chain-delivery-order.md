...
| 2, keyboard correction | [Platform shortcuts — ADR 0067](../tasks/adr-0067-task-001-platform-shortcuts.md) | Operator-requested Ctrl bindings on Linux; verify key delivery and the reported Settings stall correction to complete ADR 0066 task 003; no config changes |
| 2 | [Configuration and startup failure recovery — ADR 0066](../adr/0066-configuration-and-startup-failure-recovery.md) | Accepted - 2026-09-10; task 001 complete; [task 002 complete](../tasks/adr-0066-task-002-core-checks-and-startup-reports.md); [task 003 operator check open](../runbooks/startup-recovery-check.md#task-003-background-tools), tasks 004–013 not started in the [phase plan](adr-0066-startup-recovery-phase-plan.md); finish implementation and acceptance before config format changes |
...
| `v4vmm` | [0066 configuration/startup failure recovery](adr-0066-startup-recovery-phase-plan.md) | ADR Accepted - 2026-09-10; task 001 complete; [task 002 complete](../tasks/adr-0066-task-002-core-checks-and-startup-reports.md#operator-evidence--2026-09-10), mechanical gate Green; operator acceptance and fixture cleanup confirmed; [003 mechanical gate Green; keyboard and Settings responsiveness acceptance remain open; CPU profile identifies font parsing during layout; optimized debug text dependencies Green; operator layout now 22–24 ms; responsiveness/readability confirmation pending; using ADR 0067 Ctrl bindings; other operator checks, final preservation and fixture cleanup passed](../tasks/adr-0066-task-003-runtime-failure-and-shell-availability.md); 004–013 not started |
| `v4vmm` | [0067 platform shortcuts 001](../tasks/adr-0067-task-001-platform-shortcuts.md) | Modifier and focus corrections implemented; mechanical gate and debug build Green; operator recheck open after unreliable first-attempt delivery; shares the remaining 0066 task 003 keyboard check |
