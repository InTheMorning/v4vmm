...
Detail inspector path; a 2026-05-16 smoke-fix hydrates local
Library-origin Artists, Feeds, and Tracks in that inspector. Phase F
...
> longer the active model; see ADR 0048 for the current model.
