...
| [0066](0066-configuration-and-startup-failure-recovery.md) | Core startup requirements; in-app configuration/database repair and optional-tool setup/retry | Proposed |
