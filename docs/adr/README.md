...
| [0066](0066-configuration-and-startup-failure-recovery.md) | Core startup requirements; in-app repair and optional-tool retry; [001–003 and 005–010 complete; 004 implemented, operator gate open; 011–013 not started](../plans/adr-0066-startup-recovery-phase-plan.md) | Accepted |
