...
V1–V3 behavior, replacement presentation and both final preservation inspections
are accepted. Fixture cleanup is confirmed and task 013 is complete. This correction does not change
the maintenance authority.

Implementation partial: tasks 001–003 and 005–013 are complete, including applicable
...
preservation and cleanup complete. Restore and interrupted-upgrade repair are complete with operator acceptance, preservation and cleanup confirmed.
...
presentation, report copy and preservation are accepted, and cleanup is confirmed
on 2026-09-18. Task 013 and ADR 0074 are complete. Task 004's remaining gate
prevents full ADR implementation and keeps deferred item 6 open and item 7's
dependency unreleased.
