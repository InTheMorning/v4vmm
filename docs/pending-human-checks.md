...
- Confirm small-text readability, fixed row lines, no new vertical clipping
  relative to medium at either extreme, readable wrapped detail text and
  reachable popover controls. Restore theme/scale, verify preservation and
  confirm fixture cleanup.
- Chrome retains today's five coefficients in every packet. Its future
